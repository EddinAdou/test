...
import loginImage from '../assets/images/LoginImage.webp'; // Assurez-vous que le chemin est correct
...
const Login = () => {
  ...
  const formStyle = {
    width: '100%',
    maxWidth: '250px' // Limite la largeur du formulaire sans l'agrandir
  };
        ...
        <Col md={6} style={leftColumnStyle}>
          <Form className="mx-auto" style={formStyle}>
            ...
            <div className="text-center mt-3">
              <p>Pas inscrit ? <a href="/signup" style={linkStyle} onMouseOver={e => (e.currentTarget.style.textDecoration = linkHoverStyle.textDecoration)} onMouseOut={e => (e.currentTarget.style.textDecoration = linkStyle.textDecoration)}>Créer un compte !</a></p>
            </div>
          </Form>
        </Col>
        <Col md={6} className="d-flex align-items-center justify-content-end p-0">
          <img src={loginImage} alt="Login" className="img-fluid" style={{ height: '100vh', borderRadius: '0', marginRight: '0' }} />
        </Col>
      </Row>
    </Container>
  );
